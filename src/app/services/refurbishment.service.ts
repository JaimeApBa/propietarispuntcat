...
export class RefurbishmentService {
  ...
  getRefurbishmentsList(cif: string): any {
  ...
  getSearchedRefurbishments(cif: string, refurbishment: any): any {
  ...
  registerRefurbishment(refurbishment: any, cif: string): any {
    const url = URL_SERVICES + '/refurbishment/' + cif;
  ...
  removeRefurbishment(cif: string, refurbishment: any): any {
    const url = URL_SERVICES + '/refurbishment/' + cif + '/' + refurbishment;
  ...
  updateRefurbishment(refurbishment: any, id: number): any {
