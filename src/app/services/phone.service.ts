...
export class PhoneService {
  ...
  registerPhone(phone: any, cif: string): any {
  ...
  getSearchedPhone(cif: string, phone: any): any {
  ...
  updatePhone(id: number, phone: any): any {
    const url = URL_SERVICES + '/phone/' + id;
